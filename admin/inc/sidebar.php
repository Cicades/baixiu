  <div class="aside">
    ...
    <ul class="nav">
      ...
      <?php $article=array('posts','post-add','categories') ?>
      <li <?php echo in_array($current_page, $article)?' class=active':''; ?>>
        <a href="#menu-posts" class="<?php echo in_array($current_page, $article)?'':'collapsed'; ?>" data-toggle="collapse">
          <i class="fa fa-thumb-tack"></i>文章<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-posts" class="collapse <?php echo in_array($current_page, $article)?' in':''; ?>">
      ...
      <?php $settings=array('nav-menus','slides','settings') ?>
      <li <?php echo in_array($current_page, $settings)?' class=active':''; ?>>
        <a href="#menu-settings" class="<?php echo in_array($current_page, $settings)?'':'collapsed'; ?>" data-toggle="collapse">
          <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-settings" class="collapse <?php echo in_array($current_page, $settings)?' in':''; ?>">
